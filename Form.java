    ...
    public Form() {
        ...
        usubmit = new JButton(new AbstractAction("Submit") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/fingerprint",
                            "root", "123456");
                    String query = "INSERT INTO user_data(user_name,user_dob,user_age,user_phnum,email_id,user_address,user_gender)VALUES ('"
                            + username + "','" + dob + "','" + age + "','" +
